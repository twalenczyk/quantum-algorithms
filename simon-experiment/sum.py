...
#    B_gen.add([val,val],addl='{0}th sample'.format(i+1))

    # Maybe track some congruence classes?

    # Update generate our new congruence
#    BB = UA.cong_gen(B_gen, Ops, MaxNew=2**(n-1))
#    if UA.cong_classes(Theta,A) == UA.cong_classes(BB, B):
#        print('Congruence generated!')
#        break
